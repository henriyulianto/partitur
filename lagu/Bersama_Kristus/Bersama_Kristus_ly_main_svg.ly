...
WomenMusic = {
  ...
  >>
  e1 e1 e1 e1 e1 e1 \break
  e1 e1 e1 e1 e1 e1 \break
  e1 e1 e1 e1 e1 e1 e1 e2\break
  ...
  b4 b'8. a'8. gis'8 fis'8 gis'8 | % 32
  b2. r4 | % 33
  b4 b'8. a'8. gis'8 fis'8 e'8 | % 34
  %\shape #'((0 . 0) (0.5 . 0) (2 . -0.5) (0 . 0)) Slur
  gis'4. a'16 ( gis'16 ) fis'4 r4
  \break
  b4 b'8. a'8. gis'8 fis'8 gis'8 | % 32
  b2. r4 | % 33
  b4 b'8. a'8. gis'8 fis'8 e'8 | % 34
  %\shape #'((0 . 0) (0.5 . 0) (2 . -0.5) (0 . 0)) Slur
  gis'4. ( \slurSolid a'16 gis'16 ) fis'4 r4
  \break
  | % 35
...
MenMusic = {
  ...
  \repeat unfold 2 { \repeat unfold 2 { s1*2 } }
...
WomenVerseOneLineTwo = \lyricmode {
  ...
  tan -- pa tun -- tun -- an da -- ri -- "Nya."
}

WomenVerseOneLineOne = \lyricmode {
  Ji -- wa ki -- ta da -- ha -- ga __
  a -- kan sab -- da -- Nya yang mu -- li -- " a."
...
MenVerseTwoLineTwo = \lyricmode {
  ...
  ber -- sa -- ma ki -- ta me -- mu -- ji -- "Nya."
}

MenVerseTwoLineOne = \lyricmode {
  Ma -- ri ki -- ta se -- mu -- a __
  meng -- ha -- dap ke ha -- di -- rat -- "Nya."
